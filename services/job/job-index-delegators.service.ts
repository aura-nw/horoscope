...
import {
	...
	dbAccountRedelegationsMixin,
	dbAccountUnbondsMixin,
} from '../../mixins/dbMixinMongoose';
...
export default class IndexDelegatorsService extends Service {
	...
	async handleJob(lastId: string) {
		...
		let listValidators = [
			{
				title: 'OnBlock Ventures',
				address: 'auravaloper1pxl99s8h4g5mg564zrp4qz9k8h64l24fj0tyqy',
			},
			{
				title: 'VandaCapital',
				address: 'auravaloper1pwxv75q7e90u4vcx68x5q6j3kjlcdv0mkt04w8',
			},
			{ title: 'Validatrium', address: 'auravaloper1p55dyaekk77m5l08kjj5fyyhjdln74ly6sx7fs' },
			{
				title: 'Nochance | MMS',
				address: 'auravaloper1zdrahpddwl893lytke8sdmd6gmxyxk7umrahwj',
			},
			...
			{
				title: 'Erialos The Silver Fox',
				address: 'auravaloper18yrv3rpp2ljcnupa0jm6aa9hnaygju7tymv2hm',
			},
			...
			{
				title: '[NODERS]TEAM',
				address: 'auravaloper1vvqz6j3ucxr6n0ejdz4ck602lnyjew93cgcw4m',
			},
			{
				title: 'Soteria Trust',
				address: 'auravaloper1dh20eeewmedtgkrgqcnq7ey63t533sj4tyntxd',
			},
			...
			{
				title: 'Red thunder - node runner',
				address: 'auravaloper1jnrz5d8lufm4zjqr5lsnhj32dhq8s3d0rj4d04',
			},
			...
			{
				title: 'TienThuatToan Capital',
				address: 'auravaloper1nynpwwc2x5g4fdve7ldxw4xvu9ygchd88rfaj2',
			},
			{ title: 'goto5k', address: 'auravaloper1na3vztra9qtlwexm8580c37f4psypr9sld9wnd' },
			{
				title: 'Vault Staking',
				address: 'auravaloper15d8pcscam93rwe8q3ymsgkeh349x2w9fypnpun',
			},
			...
			{
				title: 'ramuchi.tech',
				address: 'auravaloper1et5m3tw02cf3ttym6tyctvs5j85gy3rrehjq9z',
			},
			...
			{
				title: '-STAKECRAFT-',
				address: 'auravaloper1my2s84cetqudfswymd5dwngh808xpzev9zm5sp',
			},
			{
				title: 'hodl_global_new',
				address: 'auravaloper12zydfqfj500x63npllnhtn97gx3gte4avydcn0',
			},
		];
		...
		for (let validator of listValidators) {
			const vote_count = vote_counts.find(
				(v: any) => v.operator_address === validator.address,
			)
			...
			console.log(
				`${validator.title},${validator.address},${addresses},${vote_count}/${total_votes}`,
			);
		}
