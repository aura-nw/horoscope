...
import {
    ErrorCode,
    ErrorMessage, GetFeegrantInactiveRequest, GetFeegrantRequest,
    MoleculerDBService,
    ResponseDto
} from '../../types';
/**
...
> {
    ...
    @Get('/get-grants-inactive', {
        name: 'getGrantsInactive',
        params: {
            chainid: {
                type: 'string',
                optional: false,
    ...
    async getGrantsInactive(ctx: Context<GetFeegrantInactiveRequest, Record<string, unknown>>) {
        let response: ResponseDto = {} as ResponseDto;
        if (ctx.params.nextKey) {
            try {
                new ObjectId(ctx.params.nextKey);
...
/**
     ...
     *            type: string
     *            required: false
     *          description: "Status of feegrant ['Available', 'Use up', 'Revoked', 'Fail']"
     *        - in: query
     *          name: txhash
     *          required: false
     *          schema:
...
/**
     *  @swagger
     *  /v1/feegrant/get-grants-inactive:
     *    get:
     *      tags:
     *        - Feegrant
     *      summary: Get list inactive feegrant
     *      description: Get list inactive feegrant
     *      parameters:
     *        - in: query
     *          name: chainid
     *          required: true
