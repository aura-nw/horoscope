			...
			messages: [
				{
					...
					msg: {
						...
						marketing: {
							...
							description:
								'Coin gives you the joint benefits of open blockchain technology and traditional currency by converting your cash into a stable digital currency equivalent.',
							logo: {
					...
					msg: {
						create_minter: {
							minter_instantiate_msg: {
								base_token_uri:
									'ipfs://QmPY5STkJ7274z7LSXcePKVPeGRvkv186gzFJdZv8VrqrA',
								name: 'Test linking',
								symbol: 'YNFT',
								num_tokens: 1,
								...
								royalty_payment_address:
									'aura10dyct5559d7c767mkmjmzh022fq52ara95vdje',
			...
			messages: [
				{
					...
					msg: {
						mint: {
							extension: {
								animation_url:
									'https://searare.s3.ap-southeast-1.amazonaws.com/product/6315a178d0cab2724647d329/6ee0a2d8b9624495a5fabd1fda49defa.png',
							},
							owner: 'aura15f6wn3nymdnhnh5ddlqletuptjag09tryrtpq5',
							token_id: 'token 34',
						},
					},
					funds: [],
